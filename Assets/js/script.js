...
const projects = [
    ...
    { title: 'QA: Pruebas Automatizadas', cat: 'qa', tags: ['Rest Assured', 'Karate DSL', 'Serenity BDD', 'Cucumber'],  img: './Assets/images/fondo.jpg', src: 'https://www.behance.net/gallery/237283413/Pruebas-Automatizadas-Bootcamp' }
];
