...
const projects = [
    ...
    { title: 'Pruebas Automatizadas', cat: 'qa', tags: ['Cucumber', 'Karate DSL', 'Serenity BDD', 'Gherkin'],  img: './Assets/images/fondo.jpg', src: 'https://www.behance.net/gallery/237333081/Pruebas-Automatizadas-QA-Bootcamp' },
  ];
